                ...
                <div className='bg-[#6f68d1] p-4 rounded-md'>
                    ...
                    <form action="">
                        ...
                        <div className='flex flex-col w-full gap-1 mb-3'>
                            ...
                            <input name='name' className='px-3 py-2 outline-none border border-slate-400 bg-transparent rounded-md' type="text" placeholder='Enter Your Name' required />
                        </div>

                        {/* Email field */}
                        <div className='flex flex-col w-full gap-1 mb-3'>
                            <label htmlFor="Email">Email</label>
                            <input name='email' className='px-3 py-2 outline-none border border-slate-400 bg-transparent rounded-md' type="email" placeholder='Enter Your Email' required />
                        </div>

                        {/* Password field */}
                        <div className='flex flex-col w-full gap-1 mb-3'>
                            <label htmlFor="password">Password</label>
                            <input name='password' className='px-3 py-2 outline-none border border-slate-400 bg-transparent rounded-md' type="password" placeholder='Enter Your Password' required />
                        </div>
